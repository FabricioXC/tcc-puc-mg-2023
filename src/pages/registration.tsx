...
function Registration() {
  ...
  //       );
  //     } else if (loginMode) {
  //       handleEmailSignin(params.email, params.password, handleIsLoading);
  //     } else {
  //       handleEmailSignup(params.email, params.password, handleIsLoading);
  //     }
  //   },
  // });
  ...
  return (
    <>
      ...
      >
        ...
        <MDBBtn className="mb-4" onClick={() => formik.handleSubmit()}>
          {forgotPass
            ? "Recuperar senha"
            : loginMode
            ? "Logar"
